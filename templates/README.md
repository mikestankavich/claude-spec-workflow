...
|---------|---------|-------|
| `/csw:spec` | Create specification from conversation | Feature name |
| `/csw:plan` | Generate implementation plan | `spec/{feature}/spec.md` |
| `/csw:build` | Execute implementation | `spec/{feature}/` |
| `/csw:check` | Validate PR readiness | None |
| `/csw:ship` | Complete and ship | `spec/{feature}/` |
...
3. Specs are cleaned up automatically (preserved in git history)
